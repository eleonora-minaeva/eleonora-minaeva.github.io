...
<li>
  ...
  <div id="abs-local-gov" class="paper-abstract">
    <em>
      This paper uses a nationally representative survey vignette experiment in Russia to examine how citizens evaluate hypothetical mayors under centralized authoritarian rule. Despite the regime's managerial rhetoric, respondents evaluate locally embedded and elected mayors more positively than appointed outsiders. These evaluations vary with regime orientations. Citizens who trust the national leader and view authorities as public-serving tend to interpret mayoral confrontation negatively, while those who trust the national leader but distrust broader authorities are less likely to penalize it. Among respondents who distrust both the national leader and broader authorities, confrontation is evaluated most positively. The findings suggest that appointed local executives rely on borrowed legitimacy from the vertical rather than on local ties or electoral authorization. Centralized municipal governance is therefore politically vulnerable: its acceptance depends not only on trust in the national leader, but also on whether citizens view the broader administrative hierarchy as competent and public-serving.
    </em>
